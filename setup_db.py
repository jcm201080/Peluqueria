...
# setup_db.py - DESACTIVADO EN PRODUCCIÓN
# Solo usar en desarrollo o peluqueria-demo
print("Acción bloqueada: No se puede resetear la base de datos de producción.")